...
async function main() {
  ...
  console.log(`🔐 Deploying RentEscrow with account: ${accountId}`);
  ...
  const bytecodeFile = "./artifacts/contracts/RentEscrow.sol/RentEscrow.bin";
  ...
  console.log(`✅ RentEscrow Contract deployed to: ${contractId.toString()}`);
  ...
  fs.writeFileSync("./deployment_renturscrow_output.json", JSON.stringify(deploymentInfo, null, 2));
